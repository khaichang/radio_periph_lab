proc create_ipi_design { offsetfile design_name } {
	...
	make_bd_intf_pins_external  [get_bd_intf_pins simple_fifo_0/S00_AXIS]
	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins simple_fifo_0/S00_AXIS_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins simple_fifo_0/S00_AXIS_ARESETN]
