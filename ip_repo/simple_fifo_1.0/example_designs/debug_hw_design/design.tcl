...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_net [get_bd_pins simple_fifo_0/s00_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins simple_fifo_0/s00_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
